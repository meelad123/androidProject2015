 ...
 */
public class AudioUpload extends AsyncTask<String, Void, String> {
    private String _attachmentName = "bitmap";
    private String _attachmentFileName = "bitmap.3gp";
    ...
    private byte[] _video;
    int _statusCode;
    public AudioUpload(int id, byte[] bArra, Activity con) {
        _video = bArra;
        _con = con;
        _id = id;
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        progress.setTitle("Uploading the audio");
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            URL url = new URL("http://jthcloudproject.elasticbeanstalk.com/api/v1/memories/"+ _id+"/sound");
